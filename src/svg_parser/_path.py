...
class Path:
    ...
    __slots__ = "curves", "initial_point", "current_point", "last_control", "canvas_height", "draw_move", \
                "transform_origin", "transformation", "cut", "closed"

    def __init__(self, d: str, canvas_height: float, transform_origin=True, transformation=None, cut=False):
        self.canvas_height = canvas_height
        self.transform_origin = transform_origin
        
        self.cut = cut
        self.closed = self.is_path_closed(d)
